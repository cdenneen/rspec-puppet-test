...
source ENV['GEM_SOURCE'] || "https://www.rubygems.org"
...
group :test do
  ...
  gem "rainbow", '~>2.0', '!=2.2.1',                               :require => false
end
...
group :development do
  ...
  gem "faraday_middleware", '< 0.12.1', :require => false
end
...
gem 'puppet', *location_for(ENV['PUPPET_GEM_VERSION'] || '4.10.1')
